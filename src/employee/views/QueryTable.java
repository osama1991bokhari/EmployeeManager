...
public class QueryTable extends JFrame {
	 ...
	 */public QueryTable() {
			...
			table.setModel(new DefaultTableModel(
				new Object[][] {
					{"ID", "First Name", "Last Name", "Nationality", "E-mail", "Contact Local", "Contact Home", "Profession", "Position", "Position", "Section", "Grade", "Working Status", "Project", "City", "Salary", "Other Allowance"},
					{"", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", ""},
					{"", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", ""},
					{"", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", ""},
					{"", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", ""},
	...
	public QueryTable(Employees[]queryResult) {
		setTitle("Query Result");
		setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		setBounds(100, 100, 1456, 508);
		contentPane = new JPanel();
